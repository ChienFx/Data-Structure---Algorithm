...
private:
	...
	*/
	...
	string	convertWStringToEncryptCode(const wchar_t* str);
...
public:
	...
	void makeFrequencyTable(const string _input_path, const string _freq_out_path, bool utf8_mode);

	bool loadFrequencyTable(const string _freq_path);

	void Compress(const string _input_path, const string _freq_table_path, const string _output_path, bool utf8_mode);
	void Extract(const string _encrypted_path, const string _freq_table_path, const string _output_path);
